...
const color = (theme, color) => theme === "dark" ? darkColors[color] : lightColors[color];
...
`);
const InputField = styled("div")((props) => `
...
`);
const InputWrapper = styled("label")((props) => `
    position: relative;
    display: flex;
...
`);
const InputOutline = styled("div")((props) => `
	bottom: 0;
	...
	left: 0;
    color: ${color(props.theme, "text")};
    background: ${props.isFocused ? props.color : color(props.theme, "textSecondary")};
    transition: .2s;
...
const HintText = styled("div") `
	...
	left: 18px;
`;
const WeekdayCell = styled("div")((props) => `
	color: ${color(props.theme, "text")};
	height: 24px;
`);
const CalendarHeader = styled("div")((props) => `
	display: flex;
...
`);
const CalendarPopup = styled("div")((props) => `
	background-color: ${color(props.theme, "bg")};
	position: absolute;
	z-index: 1000;
	margin-top: -18px;
...
`);
const CalendarButtonGroup = styled("div")((props) => `
	display: inherit;
...
`);
const CalendarCell = styled("div")((props) => `
...
const Overlay = styled("div") `
	...
	z-index: 900;
`;
export { DatePickerContainer, InputWrapper, InputButton, HintContainer, HintText, WeekdayCell, CalendarHeader, InputField, InputOutline, InputLabel, Input, CalendarPopup, CalendarButtonGroup, CalendarCell, CalendarGrid, Overlay, };
